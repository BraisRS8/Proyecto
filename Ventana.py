...
"background-color: rgb(242, 231, 255);")
        ...
        self.btnFactura2 = QtWidgets.QPushButton(self.tabFac)
        self.btnFactura2.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("img/tick.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnFactura2.setIcon(icon3)
        self.btnFactura2.setIconSize(QtCore.QSize(32, 32))
        self.btnFactura2.setObjectName("btnFactura2")
        self.gridLayout_5.addWidget(self.btnFactura2, 0, 7, 1, 1)
        self.btnAnular2 = QtWidgets.QPushButton(self.tabFac)
        self.btnAnular2.setText("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("img/papelera.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnAnular2.setIcon(icon4)
        self.btnAnular2.setIconSize(QtCore.QSize(32, 32))
        self.btnAnular2.setObjectName("btnAnular2")
        self.gridLayout_5.addWidget(self.btnAnular2, 0, 8, 1, 1)
