...
"color: rgb(255, 0, 0);")
        ...
        self.lblFecha.setGeometry(QtCore.QRect(350, 100, 131, 61))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.lblFecha.setFont(font)
        self.lblFecha.setObjectName("lblFecha")
        self.ent_fecha = QtWidgets.QLineEdit(self.centralwidget)
        self.ent_fecha.setGeometry(QtCore.QRect(460, 120, 151, 20))
        self.ent_fecha.setObjectName("ent_fecha")
        self.btnCalendar = QtWidgets.QPushButton(self.centralwidget)
        self.btnCalendar.setGeometry(QtCore.QRect(620, 110, 41, 41))
