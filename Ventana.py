...
"background-color: rgb(242, 231, 255);")
        ...
        self.gridFormuNP.addItem(spacerItem6, 0, 3, 1, 1)
        ...
        self.tablePro.setColumnCount(2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("img/restaurar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("img/impresora.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.toolbarPrint.setIcon(icon6)
